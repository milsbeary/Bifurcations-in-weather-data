#THIS SCRIPT CONVERTS CLEAN SINGLE VARIABLE DATA INTO TIME SERIES LENGTH 100 FOR TEMPRATURE 1 HOUR GAPS
...
write.csv(Thour_Timeseries_Final, paste("/home/mhkent/scratch/clean_timeseries/Length_100_TS/100_clean_tmp_ts_1/1hour_ts_", unique(df$STATION), rep_types[m], ".csv", sep = "")) #Writes a csv for the specified stations
