#THIS SCRIPT CONVERTS CLEAN SINGLE VARIABLE DATA INTO TIME SERIES LENGTH 100 FOR TEMPRATURE 3 HOUR GAPS

#Last modified by M. H. Kent August 9rd, 2023

#Submitted to Narval August 9rd, 2023
...
write.csv(Thour_Timeseries_Final, paste("/home/mhkent/scratch/clean_timeseries/Length_100_TS/100_clean_tmp_ts_3/3hour_ts_", unique(df$STATION), rep_types[m], ".csv", sep = "")) #Writes a csv for the specified stations
