#THIS SCRIPT CONVERTS CLEAN SINGLE VARIABLE DATA INTO TIME SERIES LENGTH 250 FOR TEMPRATURE 1 HOUR GAPS

#Last modified by M. H. Kent August 9th, 2023

#Submitted to Narval August 9th, 2023
...
#tmp_path <- "C:/Users/miles/Documents/clean_tmp_dep"
tmp_path <- "/home/mhkent/scratch/clean_data/clean_tmp_dep"
...
L = 250 #Specifying the time series length 
...
write.csv(Thour_Timeseries_Final, paste("/home/mhkent/scratch/clean_timeseries/Length_250_TS/250_clean_tmp_ts_1/1hour_ts_", unique(df$STATION), rep_types[m], ".csv", sep = "")) #Writes a csv for the specified stations
#write.csv(Thour_Timeseries_Final, paste("C:/Users/miles/Desktop/test_dep/1hour_ts_", unique(df$STATION), rep_types[m],  ".csv", sep = "")) #Writes a csv for the specified stations
