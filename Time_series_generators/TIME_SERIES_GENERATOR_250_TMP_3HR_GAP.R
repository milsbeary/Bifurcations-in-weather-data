#THIS SCRIPT CONVERTS CLEAN SINGLE VARIABLE DATA INTO TIME SERIES LENGTH 250 FOR TEMPRATURE 3 HOUR GAPS
...
write.csv(Thour_Timeseries_Final, paste("/home/mhkent/scratch/clean_timeseries/Length_250_TS/250_clean_tmp_ts_3/3hour_ts_", unique(df$STATION), rep_types[m], ".csv", sep = "")) #Writes a csv for the specified stations
