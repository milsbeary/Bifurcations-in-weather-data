#THIS SCRIPT CONVERTS CLEAN SINGLE VARIABLE DATA INTO TIME SERIES FOR DEWPOINT 1HOUR GAPS

#Last modified by M. H. Kent August 3rd, 2023

#Submitted to Narval August 3rd, 2023
...
#tmp_path <- "C:/Users/miles/Documents/clean_dew_dep"
tmp_path <- "/home/mhkent/scratch/clean_data/clean_dew_dep"
...
write.csv(Thour_Timeseries_Final, paste("/home/mhkent/scratch/clean_timeseries/clean_dew_ts_1/1hour_ts_", unique(df$STATION), rep_types[m], ".csv", sep = "")) #Writes a csv for the specified stations
