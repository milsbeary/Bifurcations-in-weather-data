#THIS SCRIPT CONVERTS CLEAN SINGLE VARIABLE DATA INTO TIME SERIES FOR DEWPOINT 3HOUR GAPS
...
write.csv(Thour_Timeseries_Final, paste("/home/mhkent/scratch/clean_timeseries/clean_dew_ts_3/3hour_ts_", unique(df$STATION), rep_types[m], ".csv", sep = "")) #Writes a csv for the specified stations
