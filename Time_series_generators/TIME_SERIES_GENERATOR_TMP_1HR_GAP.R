#THIS SCRIPT CONVERTS CLEAN SINGLE VARIABLE DATA INTO TIME SERIES FOR TEMPRATURE 1 HOUR GAPS

#Last modified by M. H. Kent August 8th, 2023

#Submitted to Narval August 8th, 2023
